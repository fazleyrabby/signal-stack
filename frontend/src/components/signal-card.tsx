    ...
    <Card className={cn(
      ...
      <div className={cn("p-0 relative flex flex-col h-full uppercase-none", isCompact ? "" : "p-4.5")}>
        <div className="flex flex-col h-full justify-between gap-3">
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between relative">
              <div className="flex items-center gap-3 min-w-0">
                <span className={cn(
                  "text-[11px] font-black uppercase tracking-widest truncate max-w-[120px]",
                  signal.score >= 8 ? "text-red-500" : signal.score >= 5 ? "text-amber-500" : "text-blue-500"
                )}>
                  {signal.source}
                </span>
                <span className="text-[11px] font-bold text-muted-foreground/60 uppercase tabular-nums shrink-0">
              ...
              {!isCompact && (
                <button
                  ...
                  className="absolute -top-1 -right-1 p-2 text-muted-foreground hover:text-primary transition-all disabled:opacity-40"
                >
                  {isBookmarking
          ...
          {!isCompact && (
            <div className="flex flex-col gap-3 mt-auto pt-3 border-t border-border/10">
